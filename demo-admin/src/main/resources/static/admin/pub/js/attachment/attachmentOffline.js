      ...
      var option = {
        ...
        success: function (res) {
          if (res.success) {
            ...
            $("#attas").append(
              '<div class="attaDiv" style="margin: 3px;line-height: 34px;">' +
              '<label class="attaName col-sm-3" style="width: 350px;">' + res.data.name + '</label>' +
              ...
              '&nbsp;' + '&nbsp;' +
              '<button type="button" class="btn-danger"  onclick="attachment.deleteAtta(this)" style="line-height: 30px;"><i class="fa fa-trash-o"></i>删除</button>' +
              '</div>'
            );
          }
          else {
